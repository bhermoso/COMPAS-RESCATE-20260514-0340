...
export const panopticoNodes = [
  buildPanopticoNode({
    ...
    workObjectIds: ['wo-municipio', 'wo-contextoia', 'wo-firebase', 'wo-documento-pls'],
...
export const territoryData = {
  ...
  domains: [
    ...
    },
    {
      ...
      x: 690,
      y: 88,
      target: { type: 'panopticoNode', id: 'pn-motores' },
      panopticoNodeIds: ['pn-motores'],
    ...
    },
    {
      ...
      x: 315,
      y: 468,
      target: { type: 'workObject', id: 'wo-evaluacion' },
      panopticoNodeIds: [],
    ...
    },
    {
      ...
      panopticoNodeIds: ['pn-firebase', 'pn-runtime'],
